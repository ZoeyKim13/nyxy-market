    ...
    <div className="grid gap-6 lg:grid-cols-5">
      ...
      <section className="space-y-4 rounded-3xl bg-white p-6 shadow-soft lg:col-span-2">
        ...
        <div className="flex gap-3">
          <button className="rounded-full bg-rose-500 px-5 py-2 text-white hover:bg-rose-700">私信卖家</button>
          <button className="rounded-full border border-rose-200 px-5 py-2 text-rose-700 hover:border-rose-500">
            收藏
          </button>
        </div>
      </section>
